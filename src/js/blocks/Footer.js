...
export default class Footer extends Component {
  ...
  componentDidMount() {
    ...
    if (footerWrapper) updateLang(footerWrapper);
  }
      ...
      <footer className="footer__wrapper">
        <div className="footer__item logo-rs__wrapper">
          <a 
            ...
            target="_blank">
            <img src={logo} className="rslogo-img" alt="logo-rs-school" />
          </a>
        </div>

        <p className="footer__item task-date">2021</p>

        <div className="footer__item author__wrapper">
          <span className="author__item lang__author">Author:</span>
          <a href="https://github.com/Arseni-p" className="author__link" target="_blank">
            ...
            <span className="author__text">Arseni-p</span>
          </a>
        </div>
      </footer>
    )
